      ...
      <div className="relative min-h-screen sm:flex sm:flex-row justify-center bg-transparent rounded-3xl shadow-xl">
        <div className="flex-col flex self-center lg:px-14 sm:max-w-4xl xl:max-w-md z-10">
          <div className="self-start hidden lg:flex flex-col text-gray-300">
            <h1 className="my-3 text-white font-semibold text-4xl">Welcome</h1>
            <p className="pr-3 text-sm opacity-75">
            Your Innovation Starts Here
Join a new era of esolang programming. Fast, effortless, and AI-driven.
        ...
        <div className="flex justify-center self-center z-10">
          <div className="p-12 bg-white mx-auto rounded-3xl w-96">
            ...
            <div className="space-y-6">
              ...
              <div className="flex justify-center gap-5 w-full pb-8">
                <button
                  type="submit"
                  className="w-full flex items-center bg-gray-200 justify-center mb-6 md:mb-0 border border-gray-300 hover:border-gray-900 hover:bg-gray-900 text-sm text-gray-500 p-3 rounded-lg tracking-wide font-medium cursor-pointer transition ease-in duration-500"
                >
                  <svg
                    className="w-4 mr-2"
                    viewBox="0 0 24 24"
